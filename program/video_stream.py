...
@Client.on_message(command(["789ppppppps", f"789ppppppps@{BOT_USERNAME}"]) & other_filters)
@check_blacklist()
...
@Client.on_message(command(["789pppppppss", f"789pppppppss@{BOT_USERNAME}"]) & other_filters)
@check_blacklist()
@require_admin(permissions=["can_manage_voice_chats", "can_delete_messages", "can_invite_users"], self=True)
