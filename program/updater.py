...
async def update_bot(_, message: Message):
    ...
    if update_avail:
        ...
        return
    await msg.edit(f"✅ CFC Music **up-to-date** with [main]({UPSTREAM_REPO}/tree/main) ❖", disable_web_page_preview=True)
...
async def restart_bot(_, message: Message):
    try:
        ...
        return
    await msg.edit_text("✅ CFC Music is restarted succesfully work in 5-10 seconds.")
